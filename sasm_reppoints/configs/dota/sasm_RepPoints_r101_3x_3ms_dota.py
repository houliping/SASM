...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_bbox_init=dict(type='NewConvexGIoULoss', loss_weight=0.375),
...
train_pipeline = [
    ...
    dict(type='RotateResize', img_scale=[(1333, 1024)], keep_ratio=True),
...
log_level = 'INFO'
work_dir = 'work_dirs/17_trick02_101/'
load_from = None
resume_from = None
workflow = [('train', 1)]
