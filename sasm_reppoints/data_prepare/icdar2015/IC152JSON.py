...
if __name__ == '__main__':
    generate_json_labels('data/ICDAR2015/airplane/train',
                         'data/ICDAR2015/airplane/train/train.json')
    generate_json_labels('data/ICDAR2015/airplane/val',
                         'data/ICDAR2015/airplane/val/test.json', trainval=False)
    print('done!')
