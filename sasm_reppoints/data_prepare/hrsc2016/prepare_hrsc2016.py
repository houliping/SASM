...
from DOTA_devkit.DOTA2COCO import DOTA2COCOTrain, DOTA2COCOTest, wordname_1
...
def preprare_hrsc2016(data_dir):
    ...
    DOTA2COCOTrain(train_dir,
                   osp.join(train_dir, 'trainval_coco.json'),
                  wordname_1)
    DOTA2COCOTest(test_dir,
                  osp.join(test_dir, 'test_coco.json'),
                  wordname_1)

if __name__ == '__main__':
    hrsc2016_dir = 'dataset/HRSC2016/HRSC2016'
