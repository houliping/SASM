...
from mmdet.core import (AnchorGeneratorRotated, sam_anchor_target,
...
class SAMS2ANetHead(nn.Module):
    ...
    def __init__(self,
                 ...
                 loss_odm_bbox=dict(
                     type='SmoothL1Loss', beta=1.0 / 9.0, loss_weight=1.0)):
        super(SAMS2ANetHead, self).__init__()
    ...
    def loss(self,
        ...
        cls_reg_targets = sam_anchor_target(
            anchor_list,
            valid_flag_list,
            gt_bboxes,
            img_metas,
        ...
        (labels_list, label_weights_list, bbox_targets_list, bbox_weights_list,
         num_total_pos, num_total_neg, label_weights_list_fam) = cls_reg_targets
        num_total_samples = (
        ...
        if cls_reg_targets is None:
            return None
        (labels_list, label_weights_list, bbox_targets_list, bbox_weights_list,
         num_total_pos, num_total_neg, label_weights_list_odm) = cls_reg_targets
        num_total_samples = (
            num_total_pos + num_total_neg if self.sampling else num_total_pos)
    ...
    def loss_fam_single(self,
        ...
        sam_weights_fam = sam_weights_fam.reshape(-1, 5)
    ...
    def loss_odm_single(self,
        ...
        sam_weights_odm = sam_weights_odm.reshape(-1, 5)
        ...
        #  use sam
        bbox_weights = bbox_weights * sam_weights_odm
