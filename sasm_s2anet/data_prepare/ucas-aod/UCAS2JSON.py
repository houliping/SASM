...
if __name__ == '__main__':
    generate_json_labels('data/airplane/train',
                         'data/airplane/train/train.json')
    generate_json_labels('data/airplane/val',
                         'data/airplane/val/test.json', trainval=False)
    print('done!')
